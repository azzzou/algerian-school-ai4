...
// AI Leads dashboard (from ai_engine leads.db) - public, no auth required
Route::get('/ai-dashboard', 'LeadController@index')->name('ai.dashboard');
Route::get('/ai-dashboard/export', 'LeadController@export')->name('ai.dashboard.export');
Route::get('/ai-dashboard/lead/{id}', 'LeadController@show')->name('ai.dashboard.show');
